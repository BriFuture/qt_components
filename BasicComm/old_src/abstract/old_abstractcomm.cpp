...
const QByteArray OldAbstractComm::LineSeparator = QByteArray("\r\n");
const int OldAbstractComm::PacketMaxSize = 400;
const CommInfo OldAbstractComm::commInfo = {QObject::tr( "AbstractComm" )};
CommState OldAbstractComm::m_state;

OldAbstractComm::OldAbstractComm() : QObject()  {
 ...
 * \endcode
 */
bool OldAbstractComm::isStarted() {
    return m_started;
}
 ...
 */
void OldAbstractComm::setStarted(const bool started) {
    m_started = started;
}
 ...
 */
void OldAbstractComm::setState(const CommState &state)
{
    m_state = state;
}

CommState &OldAbstractComm::state()
{
    return m_state;
}
 ...
 */
void OldAbstractComm::close(QIODevice *device)
{
    device->close();  // 关闭设备
 ...
 */
void OldAbstractComm::readDevice(QIODevice *device)
{
 ...
 * \endcode
 */
void OldAbstractComm::splitData()
{
 ...
 * \endcode
 */
void OldAbstractComm::writeData(QIODevice *device, const QByteArray &rawdata)
{
    if( !device->isOpen() ) {
...
bool OldAbstractComm::opened() const
{
    return m_opened;
}

void OldAbstractComm::setOpened(bool opened)
{
    m_opened = opened;
}
