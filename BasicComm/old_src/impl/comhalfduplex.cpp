...
ComHalfDuplex::ComHalfDuplex() : OldAbstractComm()
{
}
...
void ComHalfDuplex::openComm(const QString &name) {
...
void ComHalfDuplex::setCommProperty(const QString &key, const QVariant &value)
{
