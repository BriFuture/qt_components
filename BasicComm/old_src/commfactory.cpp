...
#include "impl/comfullduplex.h"
#include "impl/comhalfduplex.h"
#include "impl/commnetwork.h"
#include "impl/virtualcom.h"
 ...
 * \date 2019.03.30
 *
 * @deprecated 现在工厂类的作用由 CommManager 替代，因为并不需要重复生成 Comm 对象。
 *
